...
Question : No category - No subcategory - Template
Answer   :
...
############################################################
-->
Question : No category - No subcategory - Dans un contexte MLflow Tracking Server est ce que les notions de experiments, models, runs et version de modèle sont claires pour vous?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous me faire un point sur les détails de la création d'une image et d'un container Docker ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous me faire un point sur les couches dans un contexte Docker ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - What is the purpose of oov_token in ``tokenizer = tf.keras.preprocessing.text.Tokenizer(num_words=k_num_words, oov_token="_UNKNOWN_")``
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Classes déséquilibrées, spam par exemple. Vous faites quoi ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - MSE, RMSE, MAE, R², MAPE ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - ANOVA... Ca te dis quoi?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Silhouette, un commentaire?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Data Warehouse vs Databases ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - What is data tidying?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - What are the types of categorical data ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - D'où provient le terme recall ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Boostrapping ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Bagging ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Boosting ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - XGBoost ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - XGBoost benefits drawbacks for predictions
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous expliquer les termes "précision" et "accuracy"
Answer  :
...
############################################################
-->
Question : No category - No subcategory - C'est quoi le F1 score, que signifie-t-il, quand l'utiliser?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Le F1 score est une moyenne harmonique. Pourquoi ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Forward selection, Backward selection ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - What is a kernel?
...
############################################################
-->
Question : No category - No subcategory - Objectif de K-Means ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - WCSS… Any comment ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Homoscédasticité. Ca te dit quoi ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Quelles sont les 3 hypothèses que l'on fait en régression linéaire
Answer :
...
############################################################
-->
Question : No category - No subcategory - What is Boto3 the SDK (Software Development Kit) of AWS?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - What is a RDBMS (Relational DataBase Management System)?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - C'est quoi le machine learning ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Expliquez ce qu'est la validation croisée et pourquoi c'est important dans le contexte de l'apprentissage automatique ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Différence entre régression et classification en apprentissage automatique ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous expliquer ce qu'est l'overfitting et comment le détecter ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Quelle est la différence entre la **normalisation** et la **standardisation** des données ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Qu'est-ce qu'une fonction de coût (ou de perte) et comment est-elle utilisée dans l'apprentissage automatique ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous expliquer ce qu'est la réduction de la dimensionnalité et pourquoi est-ce important dans l'analyse de données ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Quelles sont les différences entre l'apprentissage supervisé et l'apprentissage non supervisé ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Expliquez ce qu'est la régularisation **Lasso** et en quoi elle diffère de la régularisation **Ridge** ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - C'est quoi la régularisation ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Elbow method, any comment?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Compromis biais-variance... Ca te parle ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Connaissez-vous la différence en Corrélation et Causalité ? Pouvez-vous citer quelques critères à vérifier ?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Dans le cas du Machine Learning et du Deep Learning êtes vous d'accord pour dire qu'on laisse le modèle trouver des corrélations et pas des relations de cause à effet?
Answer  :
...
############################################################
-->
Question : No category - No subcategory - Etes vous d'accord (ou pas) pour dire qu'une IA peut conseiller (il y a x% de chance que l'image soit celle d'un chat) mais qu'elle ne peut pas expliquer (l'image est un chat car...)
...
############################################################
-->
Question : No category - No subcategory - Entre moyenne et médiane. Laquelle des deux est le plus impacté par les outliers? Peux tu illustrer avec un exemple ?
...
############################################################
-->
Question : No category - No subcategory - Comment gères-tu le problème de surapprentissage (overfitting) dans un modèle de machine learning ?
...
############################################################
-->
Question : No category - No subcategory - Comment choisir entre une régression linéaire et un modèle plus complexe comme les forêts aléatoires (Random Forest) ?
...
############################################################
-->
Question : No category - No subcategory - Quelles sont les étapes typiques d'un projet de machine learning ?
...
############################################################
-->
Question : No category - No subcategory - Comment gères-tu les biais dans les données et comment t’assures-tu de l’équité dans les modèles ?
...
############################################################
-->
Question : No category - No subcategory - Quelle est ton approche pour mettre à l'échelle un modèle de machine learning en production ?
...
############################################################
-->
Question : No category - No subcategory - Vous avez un réseau de neurones. Vous ajoutez des features. Le modèle va avoir tendance à ... ? Pourquoi ?
...
############################################################
-->
Question : No category - No subcategory - Complétez la phrase suivante : "En NLP, la lemmatisation consiste à..."
...
############################################################
-->
Question : No category - No subcategory - Vous faites de la détection de spam. Vous avez reçu 1_000 mails dont 7% sont des spams. Votre modèle répond toujours ham (vs spam). Dressez la matrice de confusion et calculez precision, recall, accuracy et F1 score. Conclusion ?
...
############################################################
-->
Question : No category - No subcategory - Pouvez-vous me faire un inventaire des commandes git que vous utilisez le plus
...
############################################################
-->
Question : No category - No subcategory - Peux tu me faire un point sur MLflow Projects et me dire à quoi servent les fichiers MLproject ?
...
############################################################
-->
Question : No category - No subcategory - Quels sont les avantages d’un fichier MLproject ?
...
############################################################
-->
Question : No category - No subcategory - Qu'est-ce qui se passe après la commande suivante `mlflow run . -P learning_rate=0.02 -P n_estimators=200`
...
############################################################
-->
Question : No category - No subcategory - Vous êtes dans un environnement Python minimal. Vous utilisez MLProjects et un fichier MLproject dans lequel il y a une ligne `conda_env: conda.yaml`. À quoi ça sert, qu'est ce qui va se passer ?
...
############################################################
-->
Question : No category - No subcategory - En back propagation on fait des approximations au premier ordre. Quel pourrait être l'intérêt de travailler au second ordre?
